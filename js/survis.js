...
$(document).ready(function () {
  ...
  selectors.selectors[0] = { type: 'keywords', text: 'category:storage',    inverted: false, lock: false, count: 0 };
  selectors.selectors[1] = { type: 'keywords', text: 'category:management',    inverted: false, lock: false, count: 0 };
  selectors.selectors[2] = { type: 'keywords', text: 'category:retrieval', inverted: false, lock: false, count: 0 };
